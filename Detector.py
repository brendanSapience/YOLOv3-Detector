...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--postfix', type=str, dest = 'postfix', default = '_WithBoxes',
        help='Specify the postfix for images with bounding boxes. Default is "_WithBoxes"'
    )
    ...
    for i, img_path in enumerate(input_image_paths):
        ...
        for single_prediction in prediction:
            print("prediction:"+str(single_prediction))
